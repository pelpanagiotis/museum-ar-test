...
NSString *const SpatialAnchorsAccountId = @"d882fbfe-3db2-4962-8fc7-d9388382ec6e";

// Set this string to the account key provided for the Azure Spatial Anchors account resource.
NSString *const SpatialAnchorsAccountKey = @"8TGVYDeVpm59NjQ6DZGS99VN1kmwn7Jfa+vucivI91w=";

// Set this string to the account domain provided for the Azure Spatial Anchors account resource.
NSString *const SpatialAnchorsAccountDomain = @"westeurope.mixedreality.azure.com";
