...
SWIFT_CLASS("_TtC4ARCL14AnnotationNode")
...
@interface LocationManager (SWIFT_EXTENSION(ARCL)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC4ARCL12PolylineNode")
...
@interface SceneLocationView (SWIFT_EXTENSION(ARCL)) <ARSCNViewDelegate>
...
SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface SceneLocationView (SWIFT_EXTENSION(ARCL))
